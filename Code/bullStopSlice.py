...
buy_threshold = 1.02
stop_loss_percentages = np.linspace(0, 1, 11)

portfolio_returns = np.zeros(len(stop_loss_percentages))

for i, stop_loss_percentage in enumerate(stop_loss_percentages):
...
plt.plot(stop_loss_percentages, portfolio_returns)
